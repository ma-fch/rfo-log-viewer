...
namespace RfoLogViewer.Forms
{
    public sealed class MainForm : Form
    {
        ...
        public MainForm(OracleLogRepository repository)
        {
            ...
            this._btnRefresh = new ToolStripButton("Refresh") { DisplayStyle = ToolStripItemDisplayStyle.Text };
            this._btnRefresh.Click += (_, __) => this.RefreshCurrentView(preserveTree: true);
            ...
            this._toolStrip.Items.Add(this._btnRefresh);
        ...
        private void InitializeTree()
        {
            ...
            root.Expand();
            this._lblStatus.Text = "Connected. Select a tree node to display logs.";
        }
